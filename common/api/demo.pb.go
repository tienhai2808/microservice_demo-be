...
const file_api_demo_proto_rawDesc = "" +
	"\n" +
	"\x0eapi/demo.proto\x12\x03api\"p\n" +
	"\x05Order\x12\x0e\n" +
	...
	"CustomerID\x12+\n" +
	"\x05Items\x18\x02 \x03(\v2\x15.api.ItemWithQuantityR\x05Items\"\x15\n" +
	"\x13CreateOrderResponse2B\n" +
	"\fOrderService\x122\n" +
	"\vCreateOrder\x12\x17.api.CreateOrderRequest\x1a\n" +
	".api.OrderB8Z6github.com/tienhai2808/microservice_demo-be/common/apib\x06proto3"
...
var file_api_demo_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
